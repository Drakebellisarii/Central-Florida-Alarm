          ...
          <div key={faq.q} className="border-b border-navy/10">
            <h3>
              <button
                ...
                className="flex w-full items-center justify-between gap-6 py-7 text-left focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-navy-logo/50"
              >
            ...
            <AnimatePresence initial={false}>
              {isOpen && (
                ...
                >
                  <p className="max-w-prose2 pb-8 pr-12 font-sans text-[0.9375rem] leading-relaxed text-slate-600">
                    {faq.a}
                  </p>
                </motion.div>
              )}
