...
export const AREAS: Area[] = [
  {
    ...
    intro: [
      "Orlando is where we started, and our office on Adanson Street has been the base for this work for more than fifty years. From College Park and Baldwin Park to the lakefront streets of the older neighborhoods and the new custom homes going up across the metro, we have wired a large share of the fine properties in this city, many of them more than once as families have grown and remodeled.",
      "A city this spread out means we know the difference between a 1920s bungalow near downtown and a new build out toward the east side, and we design the system to fit the property in front of us. Whether you are building from the ground up or bringing an older Orlando home up to date, you are working with a company that has been a part of this community for three generations.",
    ],
  ...
  },
  {
    ...
    intro: [
      "Winter Park is one of the most demanding places we work, and that is a compliment to the town. The homes along the Chain of Lakes and the brick streets off Park Avenue were built with real craftsmanship, and many of them are protected by their history. Dropping modern technology into a property like that without disturbing it is exactly the kind of careful work we do best.",
      "We have spent decades learning how to bring automation, lighting, and security into Winter Park's older homes without tearing into plaster walls or ruining the millwork. Wireless lighting and shading, concealed speakers, and carefully routed wire let us deliver a thoroughly modern system inside a property that still looks every bit its age. On the newer estates along the lakes, we design from the plans and make the technology disappear entirely.",
    ],
  ...
  },
  {
    ...
    intro: [
      "Lake Nona is where a great deal of the area's new luxury construction is happening, and new construction is the ideal place to do this work. When we are involved before the drywall, we run exactly the right wire to exactly the right places, and the finished property behaves like one system from the first day you move in. We work alongside the builders shaping Lake Nona to make that happen.",
      "The custom homes and golf-course estates here are being built with high expectations, and the technology should match. We plan automation, lighting, motorized shades, theaters, and full-property networking into the property during construction, so nothing is an afterthought bolted on at the end. The result is a home where the systems were designed at the same time as the architecture, the way it should be.",
    ],
  ...
  },
  {
    ...
    intro: [
      "Celebration was planned down to the detail, and the homes here were built to a coherent architectural vision that residents tend to take seriously. That suits us. The work we do is meant to respect the property it lives in, which means systems that stay out of sight and controls that look like they belong on the wall of a well-designed home rather than in a server room.",
  ...
  },
  {
    ...
    intro: [
      "Dr. Phillips is defined by its guard-gated communities and the large estates inside them, from Bay Hill to the neighborhoods along the Sand Lake chain. A gate at the entrance is a good start, but it watches the road, not your property, and the homes here are substantial enough to warrant security and automation designed specifically for them.",
      "We design systems for Dr. Phillips estates that complement a guarded community rather than duplicate it: surveillance and access placed where they matter to your particular property, lighting and shading that make a large property comfortable to live in, and networking strong enough to cover the whole footprint. The households we serve here expect the work to be private, reliable, and invisible, and that is exactly how we build it.",
    ],
